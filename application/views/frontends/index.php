...
<div class="row">
    ...
    <?php foreach ($posts as $post) {  ?>
      ...
      <div class="col-lg-4 col-md-6 col-sm-6">
        ...
        <span style="font-size:20px; text-transform:uppercase"><a href="#"><?php echo $post->products_cat_judul ?></a></span>
...
<img src="<?php echo base_url()?>assets/frontends/img/logo-footer.png" class="img-fluid" alt="Logo">
</a>
</div>
...
<p><a href="#"><span>469-537-2410</span> (Toll-free)</a> </p>
</div>
<div class="off-address">
<p class="mb-2">Sydney, Australia </p>
<address class="mb-0">24 Farrar Parade COOROW WA 6515</address>
<p><a href="#"><span>(08) 9064 9807</span> (Toll-free)</a> </p>
</div>
</div>
...
<div class="row g-2">
<div class="col">
<a href="#"><img class="img-fluid" src="<?php echo base_url()?>assets/frontends/img/app-store.svg" alt="app-store"></a>
</div>
<div class="col">
<a href="#"><img class="img-fluid" src="<?php echo base_url()?>assets/frontends/img/google-play.svg" alt="google-play"></a>
</div>
</div>
</div>
</div>
