          ...
          <div class="dashboard-sec">
            <div class="row">
              <div class="col-md-12 col-lg-12">
                ...
                <li class="nav-item">
                <a class="nav-link active" href="<?php echo base_url() ?>profesi-hukum">PROFESI</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url() ?>spesialis-hukum">SPESIALIS</a>
                </li>
                </ul>
                </nav>
                <div class="card">
                  <div class="card-body">
                    <div class="payment-list">
                      <h3>Profesi Anda sebagai Praktisi Hukum</h3>
                      <?php $profesi= $this->Crud_m->view_where_ordering('divisi',array('divisi_status'=>'publish'),'divisi_id','ASC'); ?>
                      <?php foreach ($profesi as $row){  ?>
                      <label class="payment-radio credit-card-option mb-3">
                        <input type="radio" name="radio" value="<?=$row['divisi_id'] ?>" >
